...
public class MeiliaoBrewingRecipe implements IBrewingRecipe {
    ...
    public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
        if (isInput(input) && isIngredient(ingredient)) {
            ...
            ItemStack output = PotionUtils.setPotion(new ItemStack(Items.POTION), ModPotions.MEILIAO_POTION.get());
            return output;
        }
